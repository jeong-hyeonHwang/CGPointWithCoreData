...
class RenewalPageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if routeDM.route != nil {
            routeDM.pages = Array(routeDM.route?.pages as! Set<Page>)
        }
...
extension RenewalPageViewController {
    ...
    @objc func addPageButtonClicked() {
        let pageInfo = PageInfo(rowOrder: routeDM.routeInfoForUI.pages.count , points: [])
        
        routeDM.routeInfoForUI.pages.append(pageInfo)
        routeDM.newPageInfo.append(pageInfo)
    ...
    @objc func removeBodyPointButtonClickedObjc() {
        let pageIndex = 0
        let pointIndex = 0
        routeDM.removePointData(pageIndex: pageIndex, pointIndex: pointIndex)
    }
    ...
    @objc func updatePointDataObjc() {
        ...
        routeDM.updatePointData(pageIndex: pageIndex, pointIndex: pointIndex, targetPointInfo: afterPoint)
    }
}

extension RenewalPageViewController: UITableViewDelegate, UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return routeDM.routeInfoForUI.pages.count
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        vc.pageInfo = routeDM.routeInfoForUI.pages[index]
    ...
    func tableView(_ tableView: UITableView, accessoryButtonTappedForRowWith indexPath: IndexPath) {
        ...
        routeDM.addPointData(pageIndex: index, pointInfo: point)
    }
    ...
    func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        if editingStyle == .delete {
            routeDM.removePageData(pageIndex: index)
